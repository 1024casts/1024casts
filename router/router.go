...
import (
	...
	"1024casts/backend/handler/api/v1/comment"
	"1024casts/backend/handler/api/v1/course"
	"1024casts/backend/handler/api/v1/order"
	"1024casts/backend/handler/api/v1/plan"
	"1024casts/backend/handler/api/v1/user"
	"1024casts/backend/handler/api/v1/video"
	"1024casts/backend/handler/qiniu"
	"1024casts/backend/handler/sd"

	"1024casts/backend/handler/web"
